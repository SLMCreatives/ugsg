    ...
    return (
      <Card className="w-full max-w-md mx-auto p-8 text-center bg-white">
        ...
        <p className="text-muted-foreground mb-4 text-balance">
          Terima kasih, {name}! <br></br> Tempahan anda untuk{" "}
        ...
        <p className="text-sm text-muted-foreground text-balance">
          ...
          <br></br>Sila tiba pada masa yang ditentukan untuk slot anda. Jika
          anda perlu menetapkan semula, hubungi kami sekurang-kurangnya 24 jam
          sebelum masa.
        </p>
      </Card>
    );
